 ...
 * 
 * @author  Michael Kolling & David J. Barnes (modified by: C. Singer, A. Vu)
...
public class Square
{
    ...
    private void draw()
    {
        if(isVisible) {
            ...
            myPoly.addPoint(xPosition,yPosition + height);      //First ///The first point is the top right one
            myPoly.addPoint(xPosition,yPosition);  //Second
            myPoly.addPoint(xPosition - width,yPosition);  //Third
            myPoly.addPoint(xPosition - width,yPosition + height);  //Fourth
